...
function setupSocketAPI(http) {
  ...
  gIo.on('connection', (socket) => {
    ...
    socket.on('chat newMsg', (msg) => {
      ...
      broadcast({ type: 'chat addMsg', data: msg, userId: socket.userId })
      broadcast({ type: 'test', data: msg, userId: socket.userId })
    })
    socket.on('new order', (msg) => {
      ...
      console.log('socket.usrId', socket.userId)
      broadcast({ type: 'send to seller', data: msg, userId: socket.userId })
    })
    socket.on('change status', (msg) => {
      ...
      console.log('socket.usrId', socket.userId)
      broadcast({ type: 'accept', data: msg, userId: socket.userId })
    })
    ...
    socket.on('editOrder', (order) => {
      ...
      broadcast({ type: 'edit-order', data: order, userId: socket.userId })
    })
